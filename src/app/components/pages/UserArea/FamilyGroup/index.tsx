...
export default function FamilyGroup () {
  return (
    <div className='family-group'>
      <img className='family-group__banner' src={familyGroupImage} alt="mario family" />
      ...
      <div className='family-group__subtitle'>Don't have a code? <br /> Don't worry, you can create one</div>
